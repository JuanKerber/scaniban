...
<ul>
<li>Hello World - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/hello-world/hello-world.html">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/hello-world.html?ver=10.0.21&utm_source=npm">Run</a></li>
<li>Angular App - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/hello-world/angular">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/angular/dist/hello-world/?ver=10.0.21&utm_source=npm">Run</a></li>
<li>React App - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/hello-world/react">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/react/build/?ver=10.0.21&utm_source=npm">Run</a></li>
<li>Vue App - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/hello-world/vue">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/vue/dist/?ver=10.0.21&utm_source=npm">Run</a></li>
<li>PWA App - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/hello-world/pwa">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/pwa/helloworld-pwa.html?ver=10.0.21&utm_source=npm">Run</a></li>
<li>WebView in Android and iOS - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/v10.0.21/hello-world/webview">Github</a></li>
<li>Read Driver Licenses - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/use-case/read-a-drivers-license.html">Github</a> | <a href="https://demo.dynamsoft.com/samples/dbr/js/use-case/read-a-drivers-license.html?ver=10.0.21&utm_source=npm">Run</a></li>
<li>Fill A Form - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/use-case/fill-a-form-with-barcode-reading.html">Github</a> | <a href="https://demo.dynamsoft.com/samples/dbr/js/use-case/fill-a-form-with-barcode-reading.html?ver=10.0.21&utm_source=npm">Run</a></li>
<li>Show result information on the video - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/use-case/show-result-texts-on-the-video.html">Github</a> | <a href="https://demo.dynamsoft.com/Samples/DBR/JS/use-case/show-result-texts-on-the-video.html?ver=10.0.21&utm_source=npm">Run</a></li>
<li>Debug Camera and Collect Video Frame - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v10.0.21/others/debug">Github</a></li>
</ul>
<p>You can also:</p>
<ul>
<li>Try the Official Demo - <a href="https://demo.dynamsoft.com/barcode-reader-js/?ver=10.0.21&utm_source=npm">Run</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-demo/">Github</a></li>
<li>Try Online Examples - <a href="https://demo.dynamsoft.com/Samples/DBR/JS/index.html?ver=10.0.21&utm_source=npm">Run</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/v10.0.21/">Github</a></li>
</ul>
...
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-barcode-reader@10.0.21/dist/dbr.bundle.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
  ...
  <span class="hljs-function">(<span class="hljs-params"><span class="hljs-keyword">async</span> (</span>) =&gt;</span> {
    ...
    filter.enableResultCrossVerification(
      Dynamsoft.Core.EnumCapturedResultItemType.CRIT_BARCODE, <span class="hljs-literal">true</span>
    );
...
<p align="center" style="text-align:center; white-space: normal; ">
  ...
  &nbsp;
  <a target="_blank" href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/hello-world.html?ver=10.0.21&utm_source=npm" title="Run in Dynamsoft" style="text-decoration:none;">
...
<!--TODO: change links-->
<p>You can run the example deployed to <a href="https://demo.dynamsoft.com/Samples/DBR/JS/hello-world/hello-world.html?ver=10.0.21&utm_source=npm">the Dynamsoft Demo Server</a> or test it with <a href="https://jsfiddle.net/DynamsoftTeam/pL4e7yrd/">JSFiddle code editor</a>. </p>
...
<p>If the test doesn't go as expected, you can <a href="https://www.dynamsoft.com/company/contact/?ver=10.0.21&utm_source=npm&product=dbr&package=js">contact us</a>.</p>
...
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-core@3.0.33/dist/core.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-license@3.0.40/dist/license.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-utility@1.0.21/dist/utility.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-barcode-reader@10.0.21/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-capture-vision-router@2.0.32/dist/cvr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
<p>Or just</p>
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-barcode-reader@10.0.21/dist/dbr.bundle.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
<ul>
<li>UNPKG  </li>
</ul>
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-core@3.0.33/dist/core.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-license@3.0.40/dist/license.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-utility@1.0.21/dist/utility.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-barcode-reader@10.0.21/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-capture-vision-router@2.0.32/dist/cvr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
<p>Or just</p>
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-barcode-reader@10.0.21/dist/dbr.bundle.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<ul>
<li>https://download2.dynamsoft.com/packages/dynamsoft-core@3.0.33/dist/core.js</li>
<li>https://download2.dynamsoft.com/packages/dynamsoft-license@3.0.40/dist/license.js</li>
<li>https://download2.dynamsoft.com/packages/dynamsoft-utility@1.0.21/dist/utility.js</li>
<li>https://download2.dynamsoft.com/packages/dynamsoft-barcode-reader@10.0.21/dist/dbr.js</li>
<li>https://download2.dynamsoft.com/packages/dynamsoft-capture-vision-router@2.0.32/dist/cvr.js</li>
<li>https://download2.dynamsoft.com/packages/dynamsoft-camera-enhancer@4.0.1/dist/dce.js</li>
<li>or bundle: https://download2.dynamsoft.com/packages/dynamsoft-barcode-reader@10.0.21/dist/dbr.bundle.js</li>
</ul>
...
<p><a href="https://www.dynamsoft.com/barcode-reader/downloads/?ver=10.0.21&utm_source=npm&product=dbr&package=js">Download Dynamsoft Barcode Reader JavaScript Package</a></p></li>
<li><p>yarn</p></li>
</ul>
<pre><code class="hljs cmd language-cmd">  yarn add dynamsoft-core@<span class="hljs-number">3</span>.<span class="hljs-number">0</span>.<span class="hljs-number">33</span> --save
  yarn add dynamsoft-license@<span class="hljs-number">3</span>.<span class="hljs-number">0</span>.<span class="hljs-number">40</span> --save
  yarn add dynamsoft-utility@<span class="hljs-number">1</span>.<span class="hljs-number">0</span>.<span class="hljs-number">21</span> --save
  yarn add dynamsoft-barcode-reader@<span class="hljs-number">10</span>.<span class="hljs-number">0</span>.<span class="hljs-number">21</span> --save
  yarn add dynamsoft-capture-vision-router@<span class="hljs-number">2</span>.<span class="hljs-number">0</span>.<span class="hljs-number">32</span> --save
  ...
  yarn add dynamsoft-capture-vision-std@<span class="hljs-number">1</span>.<span class="hljs-number">0</span>.<span class="hljs-number">0</span> --save
  yarn add dynamsoft-image-processing@<span class="hljs-number">2</span>.<span class="hljs-number">0</span>.<span class="hljs-number">30</span> --save
</code></pre>
<ul>
<li>npm</li>
</ul>
<pre><code class="hljs cmd language-cmd">  npm install dynamsoft-core@<span class="hljs-number">3</span>.<span class="hljs-number">0</span>.<span class="hljs-number">33</span> --save
  npm install dynamsoft-license@<span class="hljs-number">3</span>.<span class="hljs-number">0</span>.<span class="hljs-number">40</span> --save
  npm install dynamsoft-utility@<span class="hljs-number">1</span>.<span class="hljs-number">0</span>.<span class="hljs-number">21</span> --save
  npm install dynamsoft-barcode-reader@<span class="hljs-number">10</span>.<span class="hljs-number">0</span>.<span class="hljs-number">21</span> --save
  npm install dynamsoft-capture-vision-router@<span class="hljs-number">2</span>.<span class="hljs-number">0</span>.<span class="hljs-number">32</span> --save
  ...
  npm install dynamsoft-capture-vision-std@<span class="hljs-number">1</span>.<span class="hljs-number">0</span>.<span class="hljs-number">0</span> --save
  npm install dynamsoft-image-processing@<span class="hljs-number">2</span>.<span class="hljs-number">0</span>.<span class="hljs-number">30</span> --save
</code></pre>
<p>Depending on how you downloaded the SDK and how you intend to use it, you can typically include it like this:</p>
<pre><code class="hljs html language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-core@3.0.33/dist/core.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-license@3.0.40/dist/license.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-utility@1.0.21/dist/utility.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-barcode-reader@10.0.21/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-capture-vision-router@2.0.32/dist/cvr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
<p>Or just</p>
<pre><code class="hljs html language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"./dynamsoft/distributables/dynamsoft-barcode-reader@10.0.21/dist/dbr.bundle.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
<p>or</p>
...
<p>or</p>
<pre><code class="hljs typescript language-typescript"><span class="hljs-keyword">import</span> { CoreModule, EnumCapturedResultItemType } <span class="hljs-keyword">from</span> <span class="hljs-string">'dynamsoft-core'</span>
<span class="hljs-keyword">import</span> { LicenseManager } <span class="hljs-keyword">from</span> <span class="hljs-string">'dynamsoft-license'</span>;
<span class="hljs-keyword">import</span> { CapturedResultReceiver, CaptureVisionRouter, <span class="hljs-keyword">type</span> SimplifiedCaptureVisionSettings } <span class="hljs-keyword">from</span> <span class="hljs-string">"dynamsoft-capture-vision-router"</span>;
<span class="hljs-keyword">import</span> { CameraEnhancer, CameraView } <span class="hljs-keyword">from</span> <span class="hljs-string">"dynamsoft-camera-enhancer"</span>;
<span class="hljs-keyword">import</span> { DecodedBarcodesResult } <span class="hljs-keyword">from</span> <span class="hljs-string">'dynamsoft-barcode-reader'</span>;
<span class="hljs-keyword">import</span> { MultiFrameResultCrossFilter } <span class="hljs-keyword">from</span> <span class="hljs-string">'dynamsoft-utility'</span>;
</code></pre>
<p><em>Note</em>:</p>
<ul>
...
<span class="hljs-built_in">Object</span>.assign(Dynamsoft.Core.CoreModule.engineResourcePaths, {
  <span class="hljs-attr">std</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-capture-vision-std@1.0.0/dist/"</span>,
  <span class="hljs-attr">dip</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-image-processing@2.0.30/dist/"</span>,
  <span class="hljs-attr">core</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-core@3.0.33/dist/"</span>,
  <span class="hljs-attr">license</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-license@3.0.40/dist/"</span>,
  <span class="hljs-attr">cvr</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-capture-vision-router@2.0.32/dist/"</span>,
  <span class="hljs-attr">dbr</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-barcode-reader@10.0.21/dist/"</span>,
  <span class="hljs-attr">dce</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-camera-enhancer@4.0.1/dist/"</span>,
  <span class="hljs-attr">utility</span>: <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-utility@1.0.21/dist/"</span>
});
</code></pre>
...
<span class="hljs-keyword">await</span> Dynamsoft.Core.CoreModule.loadWasm([<span class="hljs-string">"cvr"</span>, <span class="hljs-string">"dbr"</span>]);
</code></pre>
...
<p><em>Tip</em>:</p>
<p>When creating a <code>CaptureVisionRouter</code> object within a function which may be called more than once, it's best to use a "helper" variable to avoid double creation such as <code>tempRouter</code> in the following code</p>
<pre><code class="hljs javascript language-javascript">Dynamsoft.License.LicenseManager.initLicense(<span class="hljs-string">"DLS2eyJvcmdhbml6YXRpb25JRCI6IjIwMDAwMSJ9"</span>);

<span class="hljs-keyword">let</span> tempRouter = <span class="hljs-literal">null</span>;
<span class="hljs-keyword">let</span> router = <span class="hljs-literal">null</span>;
...
<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'btn-scan'</span>).addEventListener(<span class="hljs-string">'click'</span>, <span class="hljs-keyword">async</span> () =&gt; {
    <span class="hljs-keyword">try</span> {
        router = <span class="hljs-keyword">await</span> (tempRouter = tempRouter || Dynamsoft.CVR.CaptureVisionRouter.createInstance());
    } <span class="hljs-keyword">catch</span> (ex) {
        <span class="hljs-built_in">console</span>.error(ex);
    }
});
...
<p>Check out <a href="https://www.dynamsoft.com/capture-vision/docs/web/programming/javascript/api-reference/core/basic-structures/captured-result-receiver.html">CapturedResultReceiver</a> for more information.</p>
...
<pre><code class="hljs javascript language-javascript">resultReceiver.onCapturedResultReceived = <span class="hljs-function">(<span class="hljs-params">result</span>) =&gt;</span> {
  <span class="hljs-keyword">let</span> barcodes = result.items.filter(
...
<ul>
<li>"/dynamsoft-barcode-reader-js-10.0.21/dynamsoft/resources/barcode-reader/templates/"</li>
</ul>
...
<a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/?ver=10.0.21">https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/?ver=10.0.21</a>.</p>
...
<p>If you want to upgrade the SDK from an old version to a newer one, please see <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/upgrade-guide/index.html?ver=10.0.21&utm_source=npm">how to upgrade</a>.</p>
<h2 id="release-notes">Release Notes</h2>
<p>Learn about what are included in each release at <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/release-notes/index.html?ver=10.0.21&utm_source=npm">https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/release-notes/index.html</a>.</p>
<h2 id="next-steps">Next Steps</h2>
<p>Now that you have got the SDK integrated, you can choose to move forward in the following directions</p>
<ol>
<li>Check out the <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/index.html?ver=10.0.21">Official Samples and Demo</a></li>
<li>Learn about the <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/index.html?ver=10.0.21">APIs of the SDK</a></li>
</ol>
    </div>
  </body>
</html>